...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  .queue-actions { grid-column:2; display:grid; grid-template-columns:repeat(4,minmax(44px,1fr)); gap:.4rem; width:100%; }
