...
(() => {
  ...
  let token = null, selectedSong = null, selectedQueueItem = null, allResults = [], queuedItems = [], visibleResults = 0, queueLength = 0, volume = .75, playing = true, toastTimer, suggestSequence = 0;
